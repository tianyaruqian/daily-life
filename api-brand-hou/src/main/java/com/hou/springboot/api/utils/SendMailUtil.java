...
public class SendMailUtil {
            ...
            private static String myEmailSMTPHost = "smtp.qq.com";
                 //发件人邮箱
            private static String myEmailAccount = "418059544@qq.com";
                 //发件人邮箱密码（授权码）
                 //在开启SMTP服务时会获取到一个授权码，把授权码填在这里
            private static String myEmailPassword = "ihsvhuyeejswcaij";
            /**
            ...
            public static void sendEmail(String toEmailAddress, String emailTitle, String emailContent) {
                ...
                try {
                    ...
                    builder.append("\n" + emailContent);
                    //写入我的官网
                    //builder.append("\n官网：" +"git@github.com:tianyaruqian/local.git");
                    //定义要输出日期字符串的格式
                    ...
                    msg.setFrom(new InternetAddress(myEmailAccount,"天涯如浅", "UTF-8"));
                    //得到邮差对象
